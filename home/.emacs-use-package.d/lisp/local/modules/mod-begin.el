...
;;; Only load Flymake and other modes when they are allowed
...
(defun my-flymake-execution-only-when-code-checker-allowed (orig-fun &rest args)
  "Execute ORIG-FUN with ARGS only if it is allowed.
This function is intended for use as :around advice."
  (when (and (bound-and-true-p env-allow-syntax-checker)
...
(dir-locals-trigger-defvar env-allow-syntax-checker nil
  "Allow syntax checkers such as Flymake.")

(dir-locals-trigger-defvar env-allow-language-server nil
  "Allow language server via dir-locals.")

(dir-locals-trigger-defvar env-allow-deleting-whitespace nil
